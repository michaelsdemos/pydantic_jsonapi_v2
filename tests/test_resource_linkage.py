...
class TestResourceLinks:
    ...
    def test_valid_possibilities(self, linkage, message):
        structure_to_validate = {"data": linkage}
    ...
    def test_invalid_resource_identifier(self):
        structure_to_validate = {"data": {}}
        with raises(ValidationError) as e:
            ThingWithLinkageData(**structure_to_validate)
        assert e.value.errors() == [
            {"loc": ("data", "id"), "msg": "Field required", "type": "missing"},
            {"loc": ("data", "type"), "msg": "Field required", "type": "missing"},
            {
                "loc": ("data",),
    ...
    def test_invalid_resource_identifier_array(self):
        ...
        assert e.value.errors() == [
            ...
            {"loc": ("data", 0, "id"), "msg": "Field required", "type": "missing"},
            {"loc": ("data", 0, "type"), "msg": "Field required", "type": "missing"},
        ]
